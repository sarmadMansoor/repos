...
int main()
{
	/*Car a{ "Mercedes benz AMG G WAGON",2023,23,100000,4 };
	cout << "The name of Vehicle is : " << a.getMake() << endl;
	cout << "The Model of Car is  : " << a.getModel() << endl;
	cout << "The mileage  is : " << a.getMileage() << endl;
	cout << "The Price of Vehicle is : " << a.getPrice() << endl;
	cout << "The door of Vehicle is : " << a.getDoors() << endl;*/
